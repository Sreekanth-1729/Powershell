...
#SupportsShouldProcess adds WhatIf and Confirm support
...
Start-MrAutoStoppedService -ComputerName dc01 -WhatIf
Start-MrAutoStoppedService -ComputerName dc01 -Confirm
